...
?>
    ...
    <div class="rts-banner-store-area bg_store-banner bg_image">
        <div class="container">
            <div class="row">
                <div class="col-gl-12">
                    <div class="banner-content-store">
                        <h1 class="title">Visit Our Stores</h1>
                        <p class="disc">
    ...
    <div class="rts-store-area-start rts-section-gap2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="single-store-area-start">
                        ...
                        <div class="right-content">
                            <div class="location-area">
                                ...
                                <h5 class="title">Berlin Germany Store</h5>
                                <p class="disc">259 Daniel Road, FKT 2589 Berlin, Germany.</p>
                            ...
                            <div class="opening-hour">
                                ...
                                <div class="single">Mon: 8:00AM - 10:00 PM</div>
                                <div class="single">Mon: 8:00AM - 10:00 PM</div>
                                <div class="single">Mon: 8:00AM - 10:00 PM</div>
                                <div class="single">Mon: 8:00AM - 10:00 PM</div>
                                <div class="single">Mon: 8:00AM - 10:00 PM</div>
