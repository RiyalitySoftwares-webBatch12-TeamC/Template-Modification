...
<head>
    ...
    <title>GROCERIES-Grocery-Store(e-Commerce)</title>
...
<div class="rts-header-one-area-one">
    <div class="header-top-area bg-orange-red">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="logo-search-category-wrapper">
                        <a href="index.php" class="logo-area ">
                            <!-- <h1 class="d-inline text-danger">D<h2 class="d-inline text-danger">MART</h2></h1>  -->
                             <h2 class="text-warning">GROCERIES</h2>
                        </a>
                        <div class="category-search-wrapper">
                            <div class="category-btn btn-light category-hover-header">
                                <img class="parent" src="assets/images/icons/bar-1.svg" alt="icons">
                                <span>Categories</span>
                                <ul class="category-sub-menu" id="category-active-four">
                                    <li>
                                        <a href="#" class="menu-item btn-light">
                                            <img src="assets/images/icons/01.svg" alt="icons">
                                            <span>Breakfast &amp; Dairy</span>
                                            <i class="fa-regular fa-plus"></i>
                                        </a>
                                        <ul class="submenu mm-collapse">
                                            <li><a class="mobile-menu-link btn-light" href="#">Breakfast</a></li>
                                            <li><a class="mobile-menu-link btn-light" href="#">Dinner</a></li>
                                            <li><a class="mobile-menu-link btn-light" href="#"> Pumking</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#" class="menu-item btn-light">
                        ...
                        <div class="accont-wishlist-cart-area-header">
                            <a href="account.php" class="btn-border-only account btn-light">
                                <i class="fa-light fa-user"></i>
                                <span>Account</span>
                            </a>
                            <a href="wishlist.php" class="btn-border-only wishlist btn-light">
                                <i class="fa-regular fa-heart"></i>
                                <span>Wishlist</span>
                            </a>
                            <div class="btn-border-only cart category-hover-header btn-light">
        ...
        <ul class="parent-nav">
            ...
            <li class="parent"><a href="contact.php">Contact</a></li>
                        ...
                        <div class="right-btn-area">
                            <a href="#" class="btn-narrow text-orange">Trending Products</a>
